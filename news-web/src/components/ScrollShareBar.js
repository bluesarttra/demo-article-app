...
const ScrollShareBar = ({ 
  ...
  return (
    <>
      ...
      <div className={`max-w-[1190px] mx-auto fixed top-0 left-0 right-0 z-40 ${className}`} {...props}>
         <div className="max-w-[1190px] mx-auto px-2 py-3 bg-white/95 backdrop-blur-sm shadow-sm rounded-t-lg">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <button 
                ...
                className="w-8 h-8 bg-[#D7A048] rounded-full flex items-center justify-center hover:bg-[#E8B97B] hover:scale-110 active:scale-95 transition-all duration-200 shadow-md hover:shadow-lg"
                title="Copy Link"
              >
        ...
        <div className="w-full h-1 bg-gray-200 rounded-b-lg">
          <div 
            className="h-full bg-[#D7A048] transition-all duration-150 ease-out rounded-b-lg"
