...
import { getStrapiMediaURL, getArticleById } from '../../../lib/api';
  ...
  useEffect(() => {
    const fetchArticle = async () => {
      if (!articleId) {
        ...
        try {
          setLoading(true);
          // Use the list endpoint with ID filter and locale parameter
          const params = new URLSearchParams();
          params.append('filters[id][$eq]', articleId);
    ...
    fetchArticle();
  }, [articleId, locale]); // Add locale to dependencies
